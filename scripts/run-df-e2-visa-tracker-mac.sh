...
set -euo pipefail
LOCK_DIR="/tmp/df-e2-visa-tracker.lock"
...
DF_DIR="/Users/make/Projects/dark-factories/df-e2-visa-tracker"
cd "$DF_DIR"
export DF_E2_VISA_REAL_ENABLED="${DF_E2_VISA_REAL_ENABLED:-false}"
