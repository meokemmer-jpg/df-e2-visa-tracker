"""LaunchAgent-Entry fuer df-e2-visa-tracker [CRUX-MK]"""
import json
import sys
...
class AdapterOrchestrator:
    def __init__(self, state_dir: Optional[str] = None):
        self.state_dir = Path(state_dir or Path.home() / ".df-state" / "e2-visa-tracker")
    ...
    def run_daily(self) -> dict:
        ...
        audit.append_event({
            ...
            "completion_pct": report["status"]["documents_complete_pct"],
            "investment_valid": report["investment_valid"],
